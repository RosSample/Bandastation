/datum/mod_theme/blueshield
	...
	variants = list(
		"praetorian" = list(
			MOD_ICON_OVERRIDE = 'modular_bandastation/blueshield/icons/praetorian.dmi',
			MOD_WORN_ICON_OVERRIDE = 'modular_bandastation/blueshield/icons/worn_praetorian.dmi',
